                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        ...
                        <div class="product">
                            ...
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="{{ asset('storage/public/upload/'.explode(',',$product->image)[0]) }}" alt=" Product image" class="product-image">
                                </a>

                               

                                <div class="product-action action-icon-top">
                                <a href="#addcart-modal{{ $product->id }}" class="btn-product btn-cart" data-toggle="modal"><span>add to cart</span></a>
